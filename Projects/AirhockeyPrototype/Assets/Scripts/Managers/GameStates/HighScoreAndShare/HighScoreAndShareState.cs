...
public class HighScoreAndShareState : ApplicationState <HighScoreAndShareState> {
	...
	protected override void PreEnter () {
		m_Timeout = 30.0f;
		HighScoreAndShareStateGUI.Instance.PreEnter ();
	}

	protected override void Enter () {
		m_Timeout = 30.0f;
		StartCoroutine (TimeoutCoroutineName ());
		HighScoreAndShareStateGUI.Instance.Enter ();
	}

	protected override void PreLeave () {
		StopCoroutine (TimeoutCoroutineName ());
		HighScoreAndShareStateGUI.Instance.PreLeave ();
	}

	protected override void Leave () {
		StopCoroutine (TimeoutCoroutineName ());
		HighScoreAndShareStateGUI.Instance.Leave ();
	}
	...
	private IEnumerator TimeoutCoroutine () {
		...
		{
			ApplicationStateManager.Instance.TransitionToMode (ViewHighScoreState.Instance, AirhockeyManager.Instance.guiTransitionDuration);
		}
	}
}
