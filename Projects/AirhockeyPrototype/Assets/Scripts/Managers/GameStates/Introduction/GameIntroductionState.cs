...
public class GameIntroductionState : ApplicationState <GameIntroductionState> {
	...
	protected override void Enter () {
		...
		CameraManager.Instance.transform.position = AirhockeyManager.Instance.introductionCameraTransform.position;
		CameraManager.Instance.transform.rotation = AirhockeyManager.Instance.introductionCameraTransform.rotation;
	}
